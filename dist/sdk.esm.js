...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MAINNET] = '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f', _FACTORY_ADDRESS[ChainId.ROPSTEN] = '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f', _FACTORY_ADDRESS[ChainId.RINKEBY] = '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f', _FACTORY_ADDRESS[ChainId.BSC] = '0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73', _FACTORY_ADDRESS[ChainId.FANTOM] = '0x152eE697f2E276fA89E96742e9bB9aB1F2E61bE3', _FACTORY_ADDRESS[ChainId.AVALANCHE] = '0xefa94DE7a4656D787667C749f7E1223D71E9FD88', _FACTORY_ADDRESS);
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[ChainId.MAINNET] = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f', _INIT_CODE_HASH[ChainId.ROPSTEN] = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f', _INIT_CODE_HASH[ChainId.RINKEBY] = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f', _INIT_CODE_HASH[ChainId.BSC] = '0x00fb7f630766e6a796048ea87d01acd3068e8ff67d078148a3fa3f4a84f69bd5', _INIT_CODE_HASH[ChainId.FANTOM] = '0xcdf2deca40a0bd56de8e3ce5c7df6727e5b1bf2ac96f283fa9c4b3e6b42ea9d2', _INIT_CODE_HASH[ChainId.AVALANCHE] = '0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545', _INIT_CODE_HASH);
...
var Pair = /*#__PURE__*/function () {
  function Pair(chainId, tokenAmountA, tokenAmountB) {
    var tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
    ? [tokenAmountA, tokenAmountB] : [tokenAmountB, tokenAmountA];
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(chainId, tokenAmounts[0].token, tokenAmounts[1].token), 18, 'UNI-V2', 'Uniswap V2');
    this.tokenAmounts = tokenAmounts;
  }

  Pair.getAddress = function getAddress(chainId, tokenA, tokenB) {
  ...
  _proto.getOutputAmount = function getOutputAmount(chainId, inputAmount) {
    ...
    return [outputAmount, new Pair(chainId, inputReserve.add(inputAmount), outputReserve.subtract(outputAmount))];
  };

  _proto.getInputAmount = function getInputAmount(chainId, outputAmount) {
    ...
    return [inputAmount, new Pair(chainId, inputReserve.add(inputAmount), outputReserve.subtract(outputAmount))];
  };
...
var Trade = /*#__PURE__*/function () {
  function Trade(chainId, route, amount, tradeType) {
    ...
    if (tradeType === TradeType.EXACT_INPUT) {
      ...
      for (var i = 0; i < route.path.length - 1; i++) {
        ...
        var _pair$getOutputAmount = pair.getOutputAmount(chainId, amounts[i]),
      ...
      for (var _i = route.path.length - 1; _i > 0; _i--) {
        ...
        var _pair$getInputAmount = _pair.getInputAmount(chainId, amounts[_i]),
  ...
  Trade.exactIn = function exactIn(chainId, route, amountIn) {
  ...
  Trade.exactOut = function exactOut(chainId, route, amountOut) {
  ...
  currentPairs, originalAmountIn, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      try {
        ...
        var _pair$getOutputAmount2 = pair.getOutputAmount(chainId, amountIn);
      ...
      if (amountOut.token.equals(tokenOut)) {
        sortedInsert(bestTrades, new Trade(chainId, new Route([].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut), originalAmountIn, TradeType.EXACT_INPUT), maxNumResults, tradeComparator);
  ...
  currentPairs, originalAmountOut, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      try {
        ...
        var _pair$getInputAmount2 = pair.getInputAmount(chainId, amountOut);
      ...
      if (amountIn.token.equals(tokenIn)) {
        sortedInsert(bestTrades, new Trade(chainId, new Route([pair].concat(currentPairs), currencyIn, originalAmountOut.currency), originalAmountOut, TradeType.EXACT_OUTPUT), maxNumResults, tradeComparator);
      } else if (maxHops > 1 && pairs.length > 1) {
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(chainId, tokenA, tokenB, provider) {
    try {
      ...
      var address = Pair.getAddress(chainId, tokenA, tokenB);
      return Promise.resolve(new Contract(address, IUniswapV2Pair.abi, provider).getReserves()).then(function (_ref) {
        ...
        return new Pair(chainId, new TokenAmount(tokenA, balances[0]), new TokenAmount(tokenB, balances[1]));
      });
    } catch (e) {
      return Promise.reject(e);
    }
