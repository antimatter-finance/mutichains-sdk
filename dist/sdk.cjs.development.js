...
var Trade = /*#__PURE__*/function () {
  ...
  Trade.exactIn = function exactIn(chainId, route, amountIn) {
    return new Trade(chainId, route, amountIn, exports.TradeType.EXACT_INPUT);
  }
  /**
  ...
  Trade.exactOut = function exactOut(chainId, route, amountOut) {
    return new Trade(chainId, route, amountOut, exports.TradeType.EXACT_OUTPUT);
  }
  /**
  ...
  currentPairs, originalAmountIn, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountOut.token.equals(tokenOut)) {
        sortedInsert(bestTrades, new Trade(chainId, new Route([].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut), originalAmountIn, exports.TradeType.EXACT_INPUT), maxNumResults, tradeComparator);
  ...
  currentPairs, originalAmountOut, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountIn.token.equals(tokenIn)) {
        sortedInsert(bestTrades, new Trade(chainId, new Route([pair].concat(currentPairs), currencyIn, originalAmountOut.currency), originalAmountOut, exports.TradeType.EXACT_OUTPUT), maxNumResults, tradeComparator);
      } else if (maxHops > 1 && pairs.length > 1) {
